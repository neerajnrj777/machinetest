<?php $bzbuilderconfig  = config('bzbuilder');?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<title>{{ $bzbuilderconfig['cnf_appname'] }}</title>
...
<!-- Bootstrap Core CSS -->
    ...
    <!-- Legacy  Custom CSS for old bzbuilder layout -->
    <link href="{{ asset('')}}assets/template/css/legacy.css" rel="stylesheet">

    
	<link href="{{ asset('bzbuilder/css/bzbuilder5.css')}}" rel="stylesheet">
